...
@section('title', 'Créer témoignage')
@section('page-title', 'Nouveau témoignage')

@section('content')
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Créer un nouveau témoignage</h5>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('admin.testimonials.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('testimonial_text') is-invalid @enderror" id="testimonial_text" name="testimonial_text" rows="6" required>{{ old('testimonial_text') }}</textarea>
            ...
            <div class="mb-3">
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="is_active">Activer ce témoignage</label>
                </div>
            </div>
            ...
            <div class="page-edit-footer">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-check-circle"></i> Créer le témoignage
                </button>
            </div>
        </form>
    </div>
